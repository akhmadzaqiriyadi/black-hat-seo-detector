          ...
          <div className="flex justify-between items-center h-20">
            ...
            >
              <Link href="/" className="flex items-center">
                ...
                <motion.div
                  className="ml-2 text-gray-900 font-bold text-xs"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ delay: 0.2, duration: 0.5 }}
                >
                  <div className="">BLACK</div>
                  <div className="">HAT SEO</div>
            ...
            >
              <Link
                href="/contact"
                className={`bg-black text-white px-8 py-2 rounded-xl hover:bg-stone-900 transition-colors flex items-center ${
            ...
            >
              <div className="px-4 py-6 space-y-4">
                ...
                <motion.div variants={menuItemVariants}>
                  <Link
                    href="/contact"
                    className="flex items-center px-4 py-2 bg-stone-900 text-white rounded-lg"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    <Phone size={18} className="mr-2" />
                    Contact
